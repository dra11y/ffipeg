class FFmpegGen {
  ...
  /// Include or Exclude specific functions by regex pattern. Default: include all.
  /// Recommendation: use `FFInclude` to allow-list only the ones you need.
  final FFIncludeExclude functions;

  /// Include or Exclude specific structs by regex pattern. Default: include all.
  /// Recommendation: use `FFInclude` to allow-list only the ones you need.
  final FFIncludeExclude structs;

  /// Include or Exclude specific enums by regex pattern. Default: include all.
  /// Recommendation: use `FFInclude` to allow-list only the ones you need.
