...
class FFmpegFfiGenBuilder extends Builder {
  ...
  Future<void> build(BuildStep buildStep) async {
    ...
    final Map<String, dynamic> configMap = json.decode(data);
    ...
    configMap['description'] = 'FFmpeg bindings generated by ffipeg';
...
class FfiGenOK extends FfiGenResult {
  const FfiGenOK(this.generatedContent);

  final String generatedContent;
}

class FfiGenError extends FfiGenResult implements Exception {
  ...
  @override
  String toString() => '''
FfiGenError: The following error(s) occurred running FfiGen():
